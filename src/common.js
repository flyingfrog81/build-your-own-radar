...
require('./images/skao_favicon.svg')
require('./images/skao_favicon.ico')
require('./images/skao_favicon_32.png')
require('./images/skao_logo.png')
...
require('./images/skao-radar.json')
